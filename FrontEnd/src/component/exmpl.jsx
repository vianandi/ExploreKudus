...
const NavbarAdmin = () => {
  ...
  return (
    <div className="flex flex-col fixed overflow-y-auto">
      {/* Header */}
      <div className="">
        <div className=" w-screen h-full flex border-b-[3px] border-[#004AAD] bg-white">
          ...
          <div className="hidden lg:flex items-center justify-between space-x-8">
            ...
            <Link to="/admin2/pesan" className="text-[#5D5A88] hover:text-gray-300">
              Pesan
            </Link>
            <Link to="/admin2/tourdata" className="text-[#5D5A88] hover:text-gray-300">
              Wisata
            </Link>
            <Link to="/" className="text-[#5D5A88] hover:text-gray-300">
              Logout
