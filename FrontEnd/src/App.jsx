...
import NavbarAdminPesan from "./component/NavbarAdminPesan";
import { AuthProvider } from "./component/AuthContext"; // Import AuthProvider instead of AuthContext
import ParentComponent from "./pages/admin/ParentComponent";
      ...
      <Router>
        <Routes>
          ...
          <Route path="/admin2" element={<NavbarAdmin />}>
            ...
            <Route path="/admin2/tourdata" element={<TourData />} />
          </Route>
          <Route path="/admin2" element={<NavbarAdminPesan />}>
            <Route path="/admin2/pesan" element={<Admin_pesan />} />
            {/* <Route path="/admin2/tourdata" element={<TourData />} */}
          </Route>
